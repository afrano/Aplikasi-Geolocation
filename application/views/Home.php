<html lang="en">
    ...
    <head>
        ...
        <!-- //font-awesome-icons -->
        <link href="asset/fonts.googleapis.com/css?family=Shadows+Into+Light+Two&amp;subset=latin-ext" rel="stylesheet">
        <link href="asset/fonts.googleapis.com/css?family=Karla:400,400i,700,700i&amp;subset=latin-ext" rel="stylesheet">
    ...
    <body>
        ...
        <div class="stats" style="background-image: url(asset/images/tugu-jogja.jpg)">
            <div class="container">
        ...
        </div><div class="banner-bottom " id="about">
            <div class="container">
                ...
                <div class="w3ls_service_grids">
                    <div class="col-md-4 w3_agile_services_grid">
                        <div class="agile_services_grid" >
                            <div class="hover06 column">
                                <div>
                                    <figure><img src="asset/images/jalan4.jpg" alt=" " class="img-responsive" /></figure>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 w3_agile_services_grid">
                        <div class="agile_services_grid">
                            <div class="hover06 column">
                                <div>
                                    <figure><img src="asset/images/handphone_smartphone.jpg" alt=" " class="img-responsive" /></figure>
                                </div>
                            </div>
                            <div class="agile_services_grid_pos">
                    ...
                    <div class="col-md-4 w3_agile_services_grid">
                        <div class="agile_services_grid">
                            <div class="hover06 column">
                                <div>
                                    <figure><img src="asset/images/202177_620.jpg" alt=" " class="img-responsive" /></figure>
                                </div>
                            </div>
                            <div class="agile_services_grid_pos">
...
foreach ($laporan as $data) {
    ...
    echo ("addMarker($latitude, $longitude, '<b>Tanggal Laporan : $tanggal <br>Latitude : $latitude</br>Longitude :$longitude<br> ');\n");
}
?>
